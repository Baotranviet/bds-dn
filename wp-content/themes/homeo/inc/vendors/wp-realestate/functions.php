            ...
            <div class="detail-bar print-detail">
                ...
                <div class="print-header-middle">
                    <div class="print-header-middle-left">
                        ...
                        <?php homeo_property_display_full_location_without_url($post,'no-icon-title',true); ?>
                    </div>
...
add_filter('wp-realestate-property-stats-bg-color', 'homeo_property_stats_bg_color');
add_filter('wp-realestate-property-stats-border-color', 'homeo_property_stats_bg_color');
function homeo_property_stats_bg_color($color) {
	if ( homeo_get_config('main_color') != "" ) {
		$color = homeo_get_config('main_color');
	}
	return $color;
}
